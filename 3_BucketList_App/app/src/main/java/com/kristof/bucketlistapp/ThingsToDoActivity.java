package com.kristof.bucketlistapp;
    ...
    private void setupList() {
        BucketListEntry[] thingsToDo = {
          new BucketListEntry("Climb Mt Kilimanjaro", "Do it the difficult way!", R.drawable.kilimanjaro, 5),
                ...
                new BucketListEntry("Road Trip across USA", "Hire a car from the west coast, and travel to the east coast. Hire a car from the west coast, and travel to the east coast.", R.drawable.kilimanjaro, 4.5f),
